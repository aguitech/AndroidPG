...
public class AvisoPrivacidadActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_ganadores) {
            ...
            i.putExtra("ID", getIDValue);
            i.putExtra("Dios", "Mi nombre es Hector");
            i.setClass(AvisoPrivacidadActivity.this, GanadoresActivity.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.action_como_participar) {
            ...
            i.putExtra("ID", getIDValue);
            i.putExtra("Dios", "Mi nombre es Hector");
            i.setClass(AvisoPrivacidadActivity.this, ComoParticiparActivity.class);
            startActivity(i);
            return true;
        }
        if (id == R.id.action_compartir_redes) {
            ...
            i.putExtra("ID", getIDValue);
            i.putExtra("Dios", "Mi nombre es Hector");
            i.setClass(AvisoPrivacidadActivity.this, CompartirRedesActivity.class);
            startActivity(i);
            return true;
        }
        ...
        if (id == R.id.action_contacto) {
            ...
            i.putExtra("ID", getIDValue);
            i.putExtra("Dios", "Mi nombre es Hector");
            i.setClass(AvisoPrivacidadActivity.this, ContactoActivity.class);
            startActivity(i);
            return true;
        }
